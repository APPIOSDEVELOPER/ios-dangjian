...
#define WMTitleColorNormal   [UIColor colorWithRed:100.0/255.0 green:100.0/255.0 blue:100.0/255.0 alpha:1]
//  导航菜单栏的背景颜色
#define WMMenuBGColor        [UIColor colorWithRed:244.0/255.0 green:244.0/255.0 blue:244.0/255.0 alpha:1.0]


//  标题的尺寸(选中/非选中)
static CGFloat const WMTitleSizeSelected = 15.0f;
static CGFloat const WMTitleSizeNormal   = 13.0f;
//  导航菜单栏的高度
...
//  Email:  mailto:wangmchn@163.com// 版权属于原作者
