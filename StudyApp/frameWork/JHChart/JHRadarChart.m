...
- (void)drawValueView{
    ...
    for (NSInteger i = 0 ; i<self.drawPointArray.count; i++) {
        ...
        CALayer *tempLayer = [self gradientLayer:i path:path.CGPath];
...
- (CALayer*)shapeLayer:(NSInteger)i path:(CGPathRef)path{
...
- (CALayer*)gradientLayer:(NSInteger)i path:(CGPathRef)path{
...
//    62 215 220
    ...
    for (int i=0; i<4; i++) {
        [colors addObject:(id)[UIColor colorWithRed:(134.0 - (CGFloat)i * 4.0 )/255.0 green:(136.0 + (CGFloat)i * 4.0)/255.0 blue:(238.0 - (CGFloat)i * 2.0)/255.0 alpha:1].CGColor];
    }
    for (int i=0; i<2; i++) {
        [colors addObject:(id)[UIColor colorWithRed:62.0/255.0 green:215.0/255.0 blue:220.0/255.0 alpha:1].CGColor];
    }
    
    
    gradientLayer.colors = colors;//@[(id)[UIColor colorWithRed:134.0/255.0 green:136.0/255.0 blue:238.0/255.0 alpha:1].CGColor,(id)[UIColor colorWithRed:134.0/255.0 green:136.0/255.0 blue:238.0/255.0 alpha:1].CGColor,(id)[UIColor colorWithRed:62.0/255.0 green:215.0/255.0 blue:220.0/255.0 alpha:1].CGColor,(id)[UIColor colorWithRed:62.0/255.0 green:215.0/255.0 blue:220.0/255.0 alpha:1].CGColor];
    gradientLayer.startPoint = CGPointMake(0.5, 1);
    gradientLayer.endPoint = CGPointMake(0.5, 0);
    gradientLayer.frame = self.bounds;
    gradientLayer.mask = [self shapeLayer:i path:path];
